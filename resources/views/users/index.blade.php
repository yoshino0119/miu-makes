...
<div class="matchingPage">
  <header class="header">
    ...
    <div class="header_logo"><a href="{{route('home')}}"><i class="fa-3x fa-sharp fa-solid fa-magnifying-glass"></i></a></div>
    <div class="header_logo2"><a href="/users/show/{{Auth::id()}}"><i class="fa-3x fa-solid fa-user"></i></a></div>
  </header>
  <div class="container">
    <div class="mt-5">
